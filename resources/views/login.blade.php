...
<body class="d-flex justify-content-end align-items-center min-vh-100">
    <img id="background-image"class="position-absolute top-0 start-0 vh-100 z-n1 opacity-75" style="width: 60%; object-fit: cover; filter: brightness(0.6);" src="{{ asset('images/school.jpg') }}">
    <div id="login-container"class="position-relative d-flex justify-content-center align-items-center flex-column vh-100" style="background: linear-gradient(135deg, #1fa851 0%, #30d359 50%, #19c945 100%); width: 700px;">
